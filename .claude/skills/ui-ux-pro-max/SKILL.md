...
- Choosing color schemes, font systems, spacing specs, or layout systems
...
- **Stack**: Detect from project files or ask user
...
- Default icon library: **Phosphor (`@phosphor-icons/react`)**. Icons listed in `data/icons.csv` are common recommendations, not the full set.
- When a suitable icon can't be found in the recommendations:
  - **Prefer selecting any semantically appropriate icon from Phosphor's full icon set**;
  - If Phosphor doesn't have an ideal option, use **Heroicons (`@heroicons/react`)** as a fallback, maintaining style consistency (linear/filled, stroke width, corner radius style).

| Rule | Standard | Avoid | Why It Matters |
|------|----------|--------|----------------|
| **No Emoji as Structural Icons** | Use vector-based icons (e.g., Phosphor, Heroicons, react-native-vector-icons, @expo/vector-icons). | Using emojis for navigation, settings, or system controls. | Emojis are font-dependent, inconsistent across platforms, and cannot be controlled via design tokens. |
